...
# Unit tests for AmzSpApi::ApplicationManagementApiModel::Error
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationManagementApiModel::Error.new
  end
  ...
  describe 'test an instance of Error' do
    it 'should create an instance of Error' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationManagementApiModel::Error)
    end
  end
