...
# Unit tests for AmzSpApi::ApplicationManagementApiModel::ErrorList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorList' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationManagementApiModel::ErrorList.new
  end
  ...
  describe 'test an instance of ErrorList' do
    it 'should create an instance of ErrorList' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationManagementApiModel::ErrorList)
    end
  end
