...
# Unit tests for AmzSpApi::ApplicationManagementApiModel::ApplicationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplicationsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationManagementApiModel::ApplicationsApi.new
  end
  ...
  describe 'test an instance of ApplicationsApi' do
    it 'should create an instance of ApplicationsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationManagementApiModel::ApplicationsApi)
    end
  end
