...
describe AmzSpApi::ApplicationManagementApiModel::Configuration do
  let(:config) { AmzSpApi::ApplicationManagementApiModel::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ApplicationManagementApiModel.configure do |c|
    #   c.host = uri.host
