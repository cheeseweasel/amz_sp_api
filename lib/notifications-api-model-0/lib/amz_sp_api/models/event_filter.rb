...
module AmzSpApi::NotificationsApiModel
  ...
  class AmzSpApi::NotificationsApiModel::V0::EventFilter
    ...
    class AmzSpApi::NotificationsApiModel::V0::EnumAttributeValidator
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'order_change_types')
        self.order_change_types = attributes[:'order_change_types']
      end
    ...
    def valid?
      ...
      event_filter_type_validator = EnumAttributeValidator.new('', ['ANY_OFFER_CHANGED', 'ORDER_CHANGE'])
      return false unless event_filter_type_validator.valid?(@event_filter_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] event_filter_type Object to be assigned
    def event_filter_type=(event_filter_type)
      validator = EnumAttributeValidator.new('', ['ANY_OFFER_CHANGED', 'ORDER_CHANGE'])
      unless validator.valid?(event_filter_type)
        fail ArgumentError, "invalid value for \"event_filter_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::NotificationsApiModel::V0::== o.class AmzSpApi::NotificationsApiModel::V0::&&
          marketplace_ids == o.marketplace_ids &&
          order_change_types == o.order_change_types &&
          event_filter_type == o.event_filter_type &&
          aggregation_settings == o.aggregation_settings && super(o)
    end
    ...
    def hash
      [marketplace_ids, order_change_types, event_filter_type, aggregation_settings].hash
    end
