...
module AmzSpApi::NotificationsApiModel
  class AmzSpApi::NotificationsApiModel::V0::AggregationTimePeriod
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::NotificationsApiModel::V0::#AggregationTimePeriod" if constantValues.empty?
      value
    end
  end
end
