...
require 'fulfillment-outbound-api-model/models/amount'
...
require 'fulfillment-outbound-api-model/models/date_range'
require 'fulfillment-outbound-api-model/models/decimal'
require 'fulfillment-outbound-api-model/models/delivery_document'
require 'fulfillment-outbound-api-model/models/delivery_document_list'
require 'fulfillment-outbound-api-model/models/delivery_information'
require 'fulfillment-outbound-api-model/models/delivery_message'
require 'fulfillment-outbound-api-model/models/delivery_offer'
require 'fulfillment-outbound-api-model/models/delivery_offers_list'
require 'fulfillment-outbound-api-model/models/delivery_policy'
require 'fulfillment-outbound-api-model/models/delivery_preferences'
...
require 'fulfillment-outbound-api-model/models/destination'
require 'fulfillment-outbound-api-model/models/drop_off_location'
...
require 'fulfillment-outbound-api-model/models/get_delivery_offers_product'
require 'fulfillment-outbound-api-model/models/get_delivery_offers_request'
require 'fulfillment-outbound-api-model/models/get_delivery_offers_response'
require 'fulfillment-outbound-api-model/models/get_delivery_offers_result'
require 'fulfillment-outbound-api-model/models/get_delivery_offers_terms'
...
require 'fulfillment-outbound-api-model/models/ip_address'
...
require 'fulfillment-outbound-api-model/models/locker_details'
require 'fulfillment-outbound-api-model/models/money'
require 'fulfillment-outbound-api-model/models/notification_email_list'
require 'fulfillment-outbound-api-model/models/origin'
require 'fulfillment-outbound-api-model/models/package_tracking_details'
require 'fulfillment-outbound-api-model/models/payment_information'
require 'fulfillment-outbound-api-model/models/payment_information_list'
require 'fulfillment-outbound-api-model/models/product_identifier'
...
require 'fulfillment-outbound-api-model/models/submit_fulfillment_order_status_update_request'
require 'fulfillment-outbound-api-model/models/submit_fulfillment_order_status_update_response'
...
require 'fulfillment-outbound-api-model/models/variable_precision_address'
