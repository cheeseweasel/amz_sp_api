...
module AmzSpApi::MessagingApiModel::V0
  class MessagingApi
    ...
    def initialize(api_client = AmzSpApi::MessagingApiModel::V0::ApiClient.default)
    ...
    # @param body This contains the message body for a message.
    # @param marketplace_ids A marketplace identifier. This identifies the marketplace in which the order was placed. You can only specify one marketplace.
    # @param amazon_order_id An Amazon order identifier. This identifies the order for which a message is sent.
