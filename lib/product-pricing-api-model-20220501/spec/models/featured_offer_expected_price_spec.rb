...
# Unit tests for AmzSpApi::ProductPricingApiModel::FeaturedOfferExpectedPrice
...
describe 'FeaturedOfferExpectedPrice' do
  ...
  describe 'test an instance of FeaturedOfferExpectedPrice' do
    it 'should create an instance of FeaturedOfferExpectedPrice' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::FeaturedOfferExpectedPrice)
    end
  end
