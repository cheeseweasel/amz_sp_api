...
# Unit tests for AmzSpApi::ProductPricingApiModel::Offer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Offer' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricingApiModel::Offer.new
  end
  ...
  describe 'test an instance of Offer' do
    it 'should create an instance of Offer' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricingApiModel::Offer)
    end
  end
