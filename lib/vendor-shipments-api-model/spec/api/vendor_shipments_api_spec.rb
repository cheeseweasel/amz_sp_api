...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::VendorShipmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorShipmentsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::VendorShipmentsApi.new
  end
  ...
  describe 'test an instance of VendorShipmentsApi' do
    it 'should create an instance of VendorShipmentsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::VendorShipmentsApi)
    end
  end
