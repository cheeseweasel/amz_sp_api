  ...
  class VendorShipmentsApi
    ...
    def get_shipment_details_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VendorShipmentsApi.get_shipment_details ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VendorShipmentsApi#get_shipment_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def submit_shipment_confirmations_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VendorShipmentsApi.submit_shipment_confirmations ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling VendorShipmentsApi.submit_shipment_confirmations"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VendorShipmentsApi#submit_shipment_confirmations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # SubmitShipments
    ...
    def submit_shipments_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VendorShipmentsApi.submit_shipments ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling VendorShipmentsApi.submit_shipments"
      end
      # resource path
      local_var_path = '/vendor/shipping/v1/shipments'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VendorShipmentsApi#submit_shipments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
