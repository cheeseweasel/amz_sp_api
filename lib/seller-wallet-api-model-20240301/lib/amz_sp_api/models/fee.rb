...
module AmzSpApi::SellerWalletApiModel
  ...
  class AmzSpApi::SellerWalletApiModel::V20240301::Fee
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::SellerWalletApiModel::Fee` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::SellerWalletApiModel::Fee`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fee_rate_value')
        self.fee_rate_value = attributes[:'fee_rate_value']
      end
    ...
    def list_invalid_properties
      ...
      if @fee_rate_value.nil?
        invalid_properties.push('invalid value for "fee_rate_value", fee_rate_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fee_rate_value.nil?
    ...
    def ==(o)
      ...
      self.class AmzSpApi::SellerWalletApiModel::V20240301::== o.class AmzSpApi::SellerWalletApiModel::V20240301::&&
          fee_id == o.fee_id &&
          fee_type == o.fee_type &&
          fee_rate_value == o.fee_rate_value &&
    ...
    def hash
      [fee_id, fee_type, fee_rate_value, fee_amount].hash
    end
