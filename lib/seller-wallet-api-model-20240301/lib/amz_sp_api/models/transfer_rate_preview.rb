...
module AmzSpApi::SellerWalletApiModel
  ...
  class AmzSpApi::SellerWalletApiModel::V20240301::TransferRatePreview
    attr_accessor :base_amount

    attr_accessor :fx_rate_details
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::SellerWalletApiModel::TransferRatePreview` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::SellerWalletApiModel::TransferRatePreview`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fx_rate_details')
        self.fx_rate_details = attributes[:'fx_rate_details']
      end
    ...
    def list_invalid_properties
      ...
      if @fx_rate_details.nil?
        invalid_properties.push('invalid value for "fx_rate_details", fx_rate_details cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fx_rate_details.nil?
    ...
    def ==(o)
      ...
      self.class AmzSpApi::SellerWalletApiModel::V20240301::== o.class AmzSpApi::SellerWalletApiModel::V20240301::&&
          ...
          fx_rate_details == o.fx_rate_details &&
    ...
    def hash
      [base_amount, fx_rate_details, transfer_amount, fees].hash
    end
