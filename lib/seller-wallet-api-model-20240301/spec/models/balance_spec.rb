...
# Unit tests for AmzSpApi::SellerWalletApiModel::Balance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Balance' do
  before do
    # run before each test
    @instance = AmzSpApi::SellerWalletApiModel::Balance.new
  end
  ...
  describe 'test an instance of Balance' do
    it 'should create an instance of Balance' do
      expect(@instance).to be_instance_of(AmzSpApi::SellerWalletApiModel::Balance)
    end
  end
