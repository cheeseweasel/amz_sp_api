...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::FulfillmentInboundApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentInboundApi' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModel::FulfillmentInboundApi.new
  end
  ...
  describe 'test an instance of FulfillmentInboundApi' do
    it 'should create an instance of FulfillmentInboundApi' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::FulfillmentInboundApi)
    end
  end
