  ...
  class FulfillmentInboundApi
    ...
    def cancel_inbound_plan_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.cancel_inbound_plan ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.cancel_inbound_plan"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#cancel_inbound_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def cancel_self_ship_appointment_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.cancel_self_ship_appointment ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.cancel_self_ship_appointment"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.cancel_self_ship_appointment"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.cancel_self_ship_appointment"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#cancel_self_ship_appointment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_delivery_window_options_with_http_info(inbound_plan_id, shipment_id, delivery_window_option_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.confirm_delivery_window_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.confirm_delivery_window_options"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.confirm_delivery_window_options"
      end
      ...
      if @api_client.config.client_side_validation && delivery_window_option_id.nil?
        fail ArgumentError, "Missing the required parameter 'delivery_window_option_id' when calling FulfillmentInboundApi.confirm_delivery_window_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#confirm_delivery_window_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_packing_option_with_http_info(inbound_plan_id, packing_option_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.confirm_packing_option ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.confirm_packing_option"
      end
      # verify the required parameter 'packing_option_id' is set
      if @api_client.config.client_side_validation && packing_option_id.nil?
        fail ArgumentError, "Missing the required parameter 'packing_option_id' when calling FulfillmentInboundApi.confirm_packing_option"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#confirm_packing_option\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_placement_option_with_http_info(inbound_plan_id, placement_option_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.confirm_placement_option ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.confirm_placement_option"
      end
      ...
      if @api_client.config.client_side_validation && placement_option_id.nil?
        fail ArgumentError, "Missing the required parameter 'placement_option_id' when calling FulfillmentInboundApi.confirm_placement_option"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#confirm_placement_option\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_shipment_content_update_preview_with_http_info(inbound_plan_id, shipment_id, content_update_preview_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.confirm_shipment_content_update_preview ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.confirm_shipment_content_update_preview"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.confirm_shipment_content_update_preview"
      end
      ...
      if @api_client.config.client_side_validation && content_update_preview_id.nil?
        fail ArgumentError, "Missing the required parameter 'content_update_preview_id' when calling FulfillmentInboundApi.confirm_shipment_content_update_preview"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#confirm_shipment_content_update_preview\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_transportation_options_with_http_info(body, inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.confirm_transportation_options ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.confirm_transportation_options"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.confirm_transportation_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#confirm_transportation_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # createInboundPlan
    ...
    def create_inbound_plan_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.create_inbound_plan ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.create_inbound_plan"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#create_inbound_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_marketplace_item_labels_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.create_marketplace_item_labels ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.create_marketplace_item_labels"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#create_marketplace_item_labels\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_delivery_window_options_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_delivery_window_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_delivery_window_options"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.generate_delivery_window_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_delivery_window_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_packing_options_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_packing_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_packing_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_packing_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_placement_options_with_http_info(body, inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_placement_options ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.generate_placement_options"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_placement_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_placement_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_self_ship_appointment_slots_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_self_ship_appointment_slots ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.generate_self_ship_appointment_slots"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_self_ship_appointment_slots"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.generate_self_ship_appointment_slots"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_self_ship_appointment_slots\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_shipment_content_update_previews_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_shipment_content_update_previews ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.generate_shipment_content_update_previews"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_shipment_content_update_previews"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.generate_shipment_content_update_previews"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_shipment_content_update_previews\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_transportation_options_with_http_info(body, inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.generate_transportation_options ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.generate_transportation_options"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.generate_transportation_options"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#generate_transportation_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_delivery_challan_document_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_delivery_challan_document ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.get_delivery_challan_document"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.get_delivery_challan_document"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_delivery_challan_document\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_inbound_operation_status_with_http_info(operation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_inbound_operation_status ...'
      end
      # verify the required parameter 'operation_id' is set
      if @api_client.config.client_side_validation && operation_id.nil?
        fail ArgumentError, "Missing the required parameter 'operation_id' when calling FulfillmentInboundApi.get_inbound_operation_status"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_inbound_operation_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # getInboundPlan
    ...
    def get_inbound_plan_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_inbound_plan ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.get_inbound_plan"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_inbound_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_self_ship_appointment_slots_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_self_ship_appointment_slots ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.get_self_ship_appointment_slots"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.get_self_ship_appointment_slots"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/selfShipAppointmentSlots'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_self_ship_appointment_slots\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # getShipment
    ...
    def get_shipment_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_shipment ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.get_shipment"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.get_shipment"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_shipment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_shipment_content_update_preview_with_http_info(inbound_plan_id, shipment_id, content_update_preview_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.get_shipment_content_update_preview ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.get_shipment_content_update_preview"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.get_shipment_content_update_preview"
      end
      # verify the required parameter 'content_update_preview_id' is set
      if @api_client.config.client_side_validation && content_update_preview_id.nil?
        fail ArgumentError, "Missing the required parameter 'content_update_preview_id' when calling FulfillmentInboundApi.get_shipment_content_update_preview"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#get_shipment_content_update_preview\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_delivery_window_options_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_delivery_window_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_delivery_window_options"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.list_delivery_window_options"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_delivery_window_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_inbound_plan_boxes_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_inbound_plan_boxes ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_inbound_plan_boxes"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_inbound_plan_boxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_inbound_plan_items_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_inbound_plan_items ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_inbound_plan_items"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_inbound_plan_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_inbound_plan_pallets_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_inbound_plan_pallets ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_inbound_plan_pallets"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_inbound_plan_pallets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listInboundPlans
    ...
    def list_inbound_plans_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_inbound_plans ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_inbound_plans\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_item_compliance_details_with_http_info(mskus, marketplace_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_item_compliance_details ...'
      end
      # verify the required parameter 'mskus' is set
      if @api_client.config.client_side_validation && mskus.nil?
        fail ArgumentError, "Missing the required parameter 'mskus' when calling FulfillmentInboundApi.list_item_compliance_details"
      end
      # verify the required parameter 'marketplace_id' is set
      if @api_client.config.client_side_validation && marketplace_id.nil?
        fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FulfillmentInboundApi.list_item_compliance_details"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_item_compliance_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_packing_group_boxes_with_http_info(inbound_plan_id, packing_group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_packing_group_boxes ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_packing_group_boxes"
      end
      # verify the required parameter 'packing_group_id' is set
      if @api_client.config.client_side_validation && packing_group_id.nil?
        fail ArgumentError, "Missing the required parameter 'packing_group_id' when calling FulfillmentInboundApi.list_packing_group_boxes"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_packing_group_boxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_packing_group_items_with_http_info(inbound_plan_id, packing_group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_packing_group_items ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_packing_group_items"
      end
      # verify the required parameter 'packing_group_id' is set
      if @api_client.config.client_side_validation && packing_group_id.nil?
        fail ArgumentError, "Missing the required parameter 'packing_group_id' when calling FulfillmentInboundApi.list_packing_group_items"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_packing_group_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listPackingOptions
    ...
    def list_packing_options_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_packing_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_packing_options"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_packing_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_placement_options_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_placement_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_placement_options"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_placement_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listPrepDetails
    ...
    def list_prep_details_with_http_info(marketplace_id, mskus, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_prep_details ...'
      end
      # verify the required parameter 'marketplace_id' is set
      if @api_client.config.client_side_validation && marketplace_id.nil?
        fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FulfillmentInboundApi.list_prep_details"
      end
      # verify the required parameter 'mskus' is set
      if @api_client.config.client_side_validation && mskus.nil?
        fail ArgumentError, "Missing the required parameter 'mskus' when calling FulfillmentInboundApi.list_prep_details"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_prep_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listShipmentBoxes
    ...
    def list_shipment_boxes_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_shipment_boxes ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_shipment_boxes"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.list_shipment_boxes"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_shipment_boxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_shipment_content_update_previews_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_shipment_content_update_previews ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_shipment_content_update_previews"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.list_shipment_content_update_previews"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_shipment_content_update_previews\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listShipmentItems
    ...
    def list_shipment_items_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_shipment_items ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_shipment_items"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.list_shipment_items"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_shipment_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # listShipmentPallets
    ...
    def list_shipment_pallets_with_http_info(inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_shipment_pallets ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_shipment_pallets"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.list_shipment_pallets"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_shipment_pallets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_transportation_options_with_http_info(inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.list_transportation_options ...'
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.list_transportation_options"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#list_transportation_options\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def schedule_self_ship_appointment_with_http_info(body, inbound_plan_id, shipment_id, slot_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.schedule_self_ship_appointment ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.schedule_self_ship_appointment"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.schedule_self_ship_appointment"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.schedule_self_ship_appointment"
      end
      # verify the required parameter 'slot_id' is set
      if @api_client.config.client_side_validation && slot_id.nil?
        fail ArgumentError, "Missing the required parameter 'slot_id' when calling FulfillmentInboundApi.schedule_self_ship_appointment"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#schedule_self_ship_appointment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def set_packing_information_with_http_info(body, inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.set_packing_information ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.set_packing_information"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.set_packing_information"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#set_packing_information\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # setPrepDetails
    ...
    def set_prep_details_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.set_prep_details ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.set_prep_details"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/items/prepDetails'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#set_prep_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_inbound_plan_name_with_http_info(body, inbound_plan_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.update_inbound_plan_name ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.update_inbound_plan_name"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.update_inbound_plan_name"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#update_inbound_plan_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_item_compliance_details_with_http_info(body, marketplace_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.update_item_compliance_details ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.update_item_compliance_details"
      end
      # verify the required parameter 'marketplace_id' is set
      if @api_client.config.client_side_validation && marketplace_id.nil?
        fail ArgumentError, "Missing the required parameter 'marketplace_id' when calling FulfillmentInboundApi.update_item_compliance_details"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/items/compliance'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#update_item_compliance_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # updateShipmentName
    ...
    def update_shipment_name_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.update_shipment_name ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.update_shipment_name"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.update_shipment_name"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.update_shipment_name"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#update_shipment_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_shipment_source_address_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.update_shipment_source_address ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.update_shipment_source_address"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.update_shipment_source_address"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.update_shipment_source_address"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#update_shipment_source_address\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_shipment_tracking_details_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FulfillmentInboundApi.update_shipment_tracking_details ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FulfillmentInboundApi.update_shipment_tracking_details"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FulfillmentInboundApi.update_shipment_tracking_details"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FulfillmentInboundApi.update_shipment_tracking_details"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FulfillmentInboundApi#update_shipment_tracking_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
