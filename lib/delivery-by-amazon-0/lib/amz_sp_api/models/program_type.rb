...
module AmzSpApi::DeliveryByAmazon
  class AmzSpApi::DeliveryByAmazon::V0::ProgramType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::DeliveryByAmazon::V0::#ProgramType" if constantValues.empty?
      value
    end
  end
end
