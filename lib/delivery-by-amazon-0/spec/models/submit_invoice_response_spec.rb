...
# Unit tests for AmzSpApi::DeliveryByAmazon::SubmitInvoiceResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubmitInvoiceResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::DeliveryByAmazon::SubmitInvoiceResponse.new
  end
  ...
  describe 'test an instance of SubmitInvoiceResponse' do
    it 'should create an instance of SubmitInvoiceResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::DeliveryByAmazon::SubmitInvoiceResponse)
    end
  end
