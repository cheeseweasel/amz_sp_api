...
# Unit tests for AmzSpApi::DeliveryByAmazon::Blob
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Blob' do
  before do
    # run before each test
    @instance = AmzSpApi::DeliveryByAmazon::Blob.new
  end
  ...
  describe 'test an instance of Blob' do
    it 'should create an instance of Blob' do
      expect(@instance).to be_instance_of(AmzSpApi::DeliveryByAmazon::Blob)
    end
  end
end
