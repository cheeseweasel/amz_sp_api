...
# Unit tests for AmzSpApi::DeliveryByAmazon::ProgramType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProgramType' do
  before do
    # run before each test
    @instance = AmzSpApi::DeliveryByAmazon::ProgramType.new
  end
  ...
  describe 'test an instance of ProgramType' do
    it 'should create an instance of ProgramType' do
      expect(@instance).to be_instance_of(AmzSpApi::DeliveryByAmazon::ProgramType)
    end
  end
end
