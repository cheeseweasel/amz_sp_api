...
module AmzSpApi::MerchantFulfillmentApiModel
  class AmzSpApi::MerchantFulfillmentApiModel::V0::LabelFormat
    PDF = 'PDF'.freeze
    PNG = 'PNG'.freeze
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::MerchantFulfillmentApiModel::V0::#LabelFormat" if constantValues.empty?
      value
    end
  end
end
