...
module AmzSpApi::MerchantFulfillmentApiModel
  class AmzSpApi::MerchantFulfillmentApiModel::V0::FileType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::MerchantFulfillmentApiModel::V0::#FileType" if constantValues.empty?
      value
    end
  end
end
