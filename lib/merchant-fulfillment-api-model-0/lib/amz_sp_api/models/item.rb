...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class AmzSpApi::MerchantFulfillmentApiModel::V0::Item
    ...
    def hash
      [order_item_id, quantity, item_weight, item_description, transparency_code_list, item_level_seller_inputs_list, liquid_volume, is_hazmat, dangerous_goods_details].hash
    end
