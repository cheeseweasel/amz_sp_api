...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class AmzSpApi::MerchantFulfillmentApiModel::V0::ShippingService
    ...
    attr_accessor :rate_with_adjustments
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'rate_with_adjustments')
        self.rate_with_adjustments = attributes[:'rate_with_adjustments']
      end
    ...
    def list_invalid_properties
      ...
      if @rate_with_adjustments.nil?
        invalid_properties.push('invalid value for "rate_with_adjustments", rate_with_adjustments cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @rate_with_adjustments.nil?
    ...
    def ==(o)
      ...
      self.class AmzSpApi::MerchantFulfillmentApiModel::V0::== o.class AmzSpApi::MerchantFulfillmentApiModel::V0::&&
          ...
          rate == o.rate &&
          rate_with_adjustments == o.rate_with_adjustments &&
    ...
    def hash
      [shipping_service_name, carrier_name, shipping_service_id, shipping_service_offer_id, ship_date, earliest_estimated_delivery_date, latest_estimated_delivery_date, rate, rate_with_adjustments, adjustment_item_list, shipping_service_options, available_shipping_service_options, available_label_formats, available_format_options_for_label, requires_additional_seller_inputs, benefits].hash
    end
