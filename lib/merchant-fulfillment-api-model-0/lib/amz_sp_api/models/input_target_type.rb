...
module AmzSpApi::MerchantFulfillmentApiModel
  class AmzSpApi::MerchantFulfillmentApiModel::V0::InputTargetType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::MerchantFulfillmentApiModel::V0::#InputTargetType" if constantValues.empty?
      value
    end
  end
end
