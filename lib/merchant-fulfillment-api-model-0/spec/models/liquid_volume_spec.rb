...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::LiquidVolume
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LiquidVolume' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::LiquidVolume.new
  end
  ...
  describe 'test an instance of LiquidVolume' do
    it 'should create an instance of LiquidVolume' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::LiquidVolume)
    end
  end
