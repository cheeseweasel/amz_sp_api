...
# Unit tests for AmzSpApi::MerchantFulfillmentApiModel::DangerousGoodsDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DangerousGoodsDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentApiModel::DangerousGoodsDetails.new
  end
  ...
  describe 'test an instance of DangerousGoodsDetails' do
    it 'should create an instance of DangerousGoodsDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentApiModel::DangerousGoodsDetails)
    end
  end
