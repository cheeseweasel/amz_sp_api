...
module AmzSpApi::ListingsRestrictionsApiModel
  ...
  class AmzSpApi::ListingsRestrictionsApiModel::V20210801::Restriction
    ...
    class AmzSpApi::ListingsRestrictionsApiModel::V20210801::EnumAttributeValidator
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ListingsRestrictionsApiModel::Restriction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ListingsRestrictionsApiModel::Restriction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def condition_type=(condition_type)
      validator = EnumAttributeValidator.new('Object', ['new_new', 'new_open_box', 'new_oem', 'refurbished_refurbished', 'used_like_new', 'used_very_good', 'used_good', 'used_acceptable', 'collectible_like_new', 'collectible_very_good', 'collectible_good', 'collectible_acceptable', 'club_club'])
    ...
    def ==(o)
      ...
      self.class AmzSpApi::ListingsRestrictionsApiModel::V20210801::== o.class AmzSpApi::ListingsRestrictionsApiModel::V20210801::&&
