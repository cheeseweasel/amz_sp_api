...
module AmzSpApi::VendorDirectFulfillmentOrdersApiModel
  # Details of an order.
  class AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V20211228::OrderDetails
    ...
    attr_accessor :has_customizable_items
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'has_customizable_items')
        self.has_customizable_items = attributes[:'has_customizable_items']
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V20211228::== o.class AmzSpApi::VendorDirectFulfillmentOrdersApiModel::V20211228::&&
          ...
          has_customizable_items == o.has_customizable_items &&
          items == o.items
    end
    ...
    def hash
      [customer_order_number, order_date, order_status, shipment_details, tax_total, selling_party, ship_from_party, ship_to_party, bill_to_party, has_customizable_items, items].hash
    end
