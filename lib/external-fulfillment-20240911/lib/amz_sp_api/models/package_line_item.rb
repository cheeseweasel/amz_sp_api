...
module AmzSpApi::ExternalFulfillment
  ...
  class AmzSpApi::ExternalFulfillment::V20240911::PackageLineItem
    # The line item ID.
    attr_accessor :package_line_item_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ExternalFulfillment::PackageLineItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ExternalFulfillment::PackageLineItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'package_line_item_id')
        self.package_line_item_id = attributes[:'package_line_item_id']
      end
    ...
    def list_invalid_properties
      ...
      if @package_line_item_id.nil?
        invalid_properties.push('invalid value for "package_line_item_id", package_line_item_id cannot be nil.')
      end
    ...
    def valid?
      return false if @package_line_item_id.nil?
    ...
    def ==(o)
      ...
      self.class AmzSpApi::ExternalFulfillment::V20240911::== o.class AmzSpApi::ExternalFulfillment::V20240911::&&
          package_line_item_id == o.package_line_item_id &&
          quantity == o.quantity &&
    ...
    def hash
      [package_line_item_id, quantity, serial_numbers, pieces, country_of_origin, item_value].hash
    end
