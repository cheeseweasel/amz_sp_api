...
# Unit tests for AmzSpApi::FinancesApiModel::Transaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Transaction' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesApiModel::Transaction.new
  end
  ...
  describe 'test an instance of Transaction' do
    it 'should create an instance of Transaction' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesApiModel::Transaction)
    end
  end
