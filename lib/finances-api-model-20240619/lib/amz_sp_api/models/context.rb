...
module AmzSpApi::FinancesApiModel
  ...
  class AmzSpApi::FinancesApiModel::V20240619::Context
    ...
    def valid?
      ...
      store_name_validator = EnumAttributeValidator.new('', ['AMAZON_HAUL'])
    ...
    def store_name=(store_name)
      validator = EnumAttributeValidator.new('', ['AMAZON_HAUL'])
    ...
    def hash
      [context_type, store_name, order_type, channel, asin, sku, quantity_shipped, fulfillment_network, payment_type, payment_method, payment_reference, payment_date, deferral_reason, maturity_date, start_time, end_time].hash
    end
