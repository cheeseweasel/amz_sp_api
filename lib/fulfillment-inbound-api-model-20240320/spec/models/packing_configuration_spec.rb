...
# Unit tests for AmzSpApi::FulfillmentInboundApiModel::PackingConfiguration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackingConfiguration' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundApiModel::PackingConfiguration.new
  end
  ...
  describe 'test an instance of PackingConfiguration' do
    it 'should create an instance of PackingConfiguration' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundApiModel::PackingConfiguration)
    end
  end
