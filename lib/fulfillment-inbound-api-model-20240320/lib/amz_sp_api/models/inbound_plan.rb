...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class AmzSpApi::FulfillmentInboundApiModel::V20240320::InboundPlan
    ...
    attr_accessor :placement_options
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FulfillmentInboundApiModel::InboundPlan` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FulfillmentInboundApiModel::InboundPlan`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'packing_options')
        if (value = attributes[:'packing_options']).is_a?(Array)
          self.packing_options = value
        end
      end

      if attributes.key?(:'placement_options')
        if (value = attributes[:'placement_options']).is_a?(Array)
          self.placement_options = value
        end
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::FulfillmentInboundApiModel::V20240320::== o.class AmzSpApi::FulfillmentInboundApiModel::V20240320::&&
          ...
          name == o.name &&
          packing_options == o.packing_options &&
          placement_options == o.placement_options &&
    ...
    def hash
      [created_at, inbound_plan_id, last_updated_at, marketplace_ids, name, packing_options, placement_options, shipments, source_address, status].hash
    end
