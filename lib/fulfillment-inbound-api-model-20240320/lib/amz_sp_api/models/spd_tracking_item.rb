...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class AmzSpApi::FulfillmentInboundApiModel::V20240320::SpdTrackingItem
    ...
    attr_accessor :tracking_number_validation_status
    ...
    def self.openapi_types
      {
        :'box_id' => :'Object',
        :'tracking_id' => :'Object',
        :'tracking_number_validation_status' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FulfillmentInboundApiModel::SpdTrackingItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FulfillmentInboundApiModel::SpdTrackingItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tracking_number_validation_status')
        self.tracking_number_validation_status = attributes[:'tracking_number_validation_status']
      end
    end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::FulfillmentInboundApiModel::V20240320::== o.class AmzSpApi::FulfillmentInboundApiModel::V20240320::&&
          ...
          tracking_number_validation_status == o.tracking_number_validation_status
    end
    ...
    def hash
      [box_id, tracking_id, tracking_number_validation_status].hash
    end
