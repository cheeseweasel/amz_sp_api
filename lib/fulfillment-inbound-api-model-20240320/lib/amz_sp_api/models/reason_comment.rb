...
module AmzSpApi::FulfillmentInboundApiModel
  class AmzSpApi::FulfillmentInboundApiModel::V20240320::ReasonComment
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentInboundApiModel::V20240320::#ReasonComment" if constantValues.empty?
      value
    end
  end
end
