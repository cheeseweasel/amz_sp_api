...
module AmzSpApi::ApplicationIntegrationsApiModel
  ...
  class AmzSpApi::ApplicationIntegrationsApiModel::V0::CreateNotificationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ApplicationIntegrationsApiModel::CreateNotificationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ApplicationIntegrationsApiModel::CreateNotificationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @notification_parameters.nil?
        invalid_properties.push('invalid value for "notification_parameters", notification_parameters cannot be nil.')
      end
    ...
    def hash
      [template_id, notification_parameters, marketplace_id].hash
    end
