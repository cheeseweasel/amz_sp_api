...
module AmzSpApi::ShipmentInvoicingApiModel
  class AmzSpApi::ShipmentInvoicingApiModel::V0::AddressTypeEnum
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ShipmentInvoicingApiModel::V0::#AddressTypeEnum" if constantValues.empty?
      value
    end
  end
end
