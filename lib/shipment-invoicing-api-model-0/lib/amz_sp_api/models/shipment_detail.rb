...
module AmzSpApi::ShipmentInvoicingApiModel
  ...
  class AmzSpApi::ShipmentInvoicingApiModel::V0::ShipmentDetail
    ...
    def hash
      [warehouse_id, amazon_order_id, amazon_shipment_id, purchase_date, shipping_address, payment_method_details, payments, marketplace_id, seller_id, buyer_name, buyer_county, buyer_tax_info, marketplace_tax_info, seller_display_name, shipment_items].hash
    end
