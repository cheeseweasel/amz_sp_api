...
module AmzSpApi::OrdersApiModel
  class AmzSpApi::OrdersApiModel::V0::EasyShipShipmentStatus
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::OrdersApiModel::V0::#EasyShipShipmentStatus" if constantValues.empty?
      value
    end
  end
end
