...
module AmzSpApi::OrdersApiModel
  class AmzSpApi::OrdersApiModel::V0::AssociationType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::OrdersApiModel::V0::#AssociationType" if constantValues.empty?
      value
    end
  end
end
