...
module AmzSpApi::OrdersApiModel
  class AmzSpApi::OrdersApiModel::V0::OtherDeliveryAttributes
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::OrdersApiModel::V0::#OtherDeliveryAttributes" if constantValues.empty?
      value
    end
  end
end
