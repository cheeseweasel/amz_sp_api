...
module AmzSpApi::OrdersApiModel
  ...
  class AmzSpApi::OrdersApiModel::V0::OrderAddress
    ...
    attr_accessor :buyer_company_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'buyer_company_name')
        self.buyer_company_name = attributes[:'buyer_company_name']
      end
    ...
    def hash
      [amazon_order_id, buyer_company_name, shipping_address, delivery_preferences].hash
    end
