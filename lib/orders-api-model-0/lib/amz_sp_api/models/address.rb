...
module AmzSpApi::OrdersApiModel
  ...
  class AmzSpApi::OrdersApiModel::V0::Address
    # The name.
    attr_accessor :name
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'extended_fields')
        self.extended_fields = attributes[:'extended_fields']
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::OrdersApiModel::V0::== o.class AmzSpApi::OrdersApiModel::V0::&&
          ...
          phone == o.phone &&
          extended_fields == o.extended_fields &&
    ...
    def hash
      [name, company_name, address_line1, address_line2, address_line3, city, county, district, state_or_region, municipality, postal_code, country_code, phone, extended_fields, address_type].hash
    end
