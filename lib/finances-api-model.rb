...
# Models
require 'finances-api-model/models/adhoc_disbursement_event'
require 'finances-api-model/models/adhoc_disbursement_event_list'
...
require 'finances-api-model/models/capacity_reservation_billing_event'
require 'finances-api-model/models/capacity_reservation_billing_event_list'
...
require 'finances-api-model/models/charge_refund_event'
require 'finances-api-model/models/charge_refund_event_list'
require 'finances-api-model/models/charge_refund_transaction'
require 'finances-api-model/models/charge_refund_transactions'
...
require 'finances-api-model/models/failed_adhoc_disbursement_event'
require 'finances-api-model/models/failed_adhoc_disbursement_event_list'
...
require 'finances-api-model/models/tds_reimbursement_event'
require 'finances-api-model/models/tds_reimbursement_event_list'
...
require 'finances-api-model/models/value_added_service_charge_event'
require 'finances-api-model/models/value_added_service_charge_event_list'
