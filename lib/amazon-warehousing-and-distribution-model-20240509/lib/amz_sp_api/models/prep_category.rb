...
module AmzSpApi::AmazonWarehousingAndDistributionModel
  class AmzSpApi::AmazonWarehousingAndDistributionModel::V20240509::PrepCategory
    ADULT = 'ADULT'.freeze
    BABY = 'BABY'.freeze
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::AmazonWarehousingAndDistributionModel::V20240509::#PrepCategory" if constantValues.empty?
      value
    end
  end
end
