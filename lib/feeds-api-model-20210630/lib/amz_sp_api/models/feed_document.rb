...
module AmzSpApi::FeedsApiModel
  ...
  class AmzSpApi::FeedsApiModel::V20210630::FeedDocument
    ...
    class AmzSpApi::FeedsApiModel::V20210630::EnumAttributeValidator
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FeedsApiModel::FeedDocument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FeedsApiModel::FeedDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'feed_document_id')
        self.feed_document_id = attributes[:'feed_document_id']
      end
      ...
      if attributes.key?(:'compression_algorithm')
    ...
    def compression_algorithm=(compression_algorithm)
      validator = EnumAttributeValidator.new('Object', ['GZIP'])
