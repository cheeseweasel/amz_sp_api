...
module AmzSpApi::ProductTypeDefinitionsApiModel::V20200901
  class DefinitionsApi
    ...
    def initialize(api_client = AmzSpApi::ProductTypeDefinitionsApiModel::V20200901::ApiClient.default)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :keywords A comma-delimited list of keywords to search product types. **Note:** Cannot be used with &#x60;itemName&#x60;.
    # @option opts [String] :item_name The title of the ASIN to get the product type recommendation. **Note:** Cannot be used with &#x60;keywords&#x60;.
    # @option opts [String] :locale The locale for the display names in the response. Defaults to the primary locale of the marketplace.
    # @option opts [String] :search_locale The locale used for the &#x60;keywords&#x60; and &#x60;itemName&#x60; parameters. Defaults to the primary locale of the marketplace.
    ...
    def search_definitions_product_types_with_http_info(marketplace_ids, opts = {})
      ...
      query_params[:'itemName'] = opts[:'item_name'] if !opts[:'item_name'].nil?
      query_params[:'locale'] = opts[:'locale'] if !opts[:'locale'].nil?
      query_params[:'searchLocale'] = opts[:'search_locale'] if !opts[:'search_locale'].nil?
