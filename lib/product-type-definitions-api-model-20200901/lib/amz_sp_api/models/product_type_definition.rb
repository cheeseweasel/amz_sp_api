...
module AmzSpApi::ProductTypeDefinitionsApiModel
  ...
  class AmzSpApi::ProductTypeDefinitionsApiModel::V20200901::ProductTypeDefinition
    ...
    class AmzSpApi::ProductTypeDefinitionsApiModel::V20200901::EnumAttributeValidator
    ...
    def hash
      [meta_schema, schema, requirements, requirements_enforced, property_groups, locale, marketplace_ids, product_type, display_name, product_type_version].hash
    end
