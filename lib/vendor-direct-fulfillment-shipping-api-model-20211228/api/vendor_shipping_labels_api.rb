...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel::V20211228
  class VendorShippingLabelsApi
    ...
    def initialize(api_client = AmzSpApi::VendorDirectFulfillmentShippingApiModel::V20211228::ApiClient.default)
    ...
    def create_shipping_labels(body, purchase_order_number, opts = {})
      data, _status_code, _headers = create_shipping_labels_with_http_info(body, purchase_order_number, opts)
      data
    end
    ...
    def create_shipping_labels_with_http_info(body, purchase_order_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VendorShippingLabelsApi.create_shipping_labels ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling VendorShippingLabelsApi.create_shipping_labels"
      end
      ...
      if @api_client.config.client_side_validation && purchase_order_number.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_number' when calling VendorShippingLabelsApi.create_shipping_labels"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VendorShippingLabelsApi#create_shipping_labels\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :sort_order The sort order creation date. You can choose between ascending (&#x60;ASC&#x60;) or descending (&#x60;DESC&#x60;) sort order. (default to ASC)
