...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  ...
  class AmzSpApi::VendorDirectFulfillmentShippingApiModel::V20211228::CreateContainerLabelRequest
    ...
    attr_accessor :vendor_container_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::VendorDirectFulfillmentShippingApiModel::CreateContainerLabelRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::VendorDirectFulfillmentShippingApiModel::CreateContainerLabelRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vendor_container_id')
        self.vendor_container_id = attributes[:'vendor_container_id']
      end
    ...
    def list_invalid_properties
      ...
      if @vendor_container_id.nil?
        invalid_properties.push('invalid value for "vendor_container_id", vendor_container_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vendor_container_id.nil?
    ...
    def ==(o)
      ...
      self.class AmzSpApi::VendorDirectFulfillmentShippingApiModel::V20211228::== o.class AmzSpApi::VendorDirectFulfillmentShippingApiModel::V20211228::&&
          selling_party == o.selling_party &&
          ship_from_party == o.ship_from_party &&
          carrier_id == o.carrier_id &&
          vendor_container_id == o.vendor_container_id &&
          packages == o.packages
    end
    ...
    def hash
      [selling_party, ship_from_party, carrier_id, vendor_container_id, packages].hash
    end
