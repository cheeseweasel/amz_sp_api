...
module AmzSpApi::ServicesApiModel
  ...
  class AmzSpApi::ServicesApiModel::V0::FixedSlot
    ...
    attr_accessor :scheduled_capacity
    ...
    attr_accessor :encumbered_capacity
    ...
    attr_accessor :reserved_capacity
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ServicesApiModel::FixedSlot` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ServicesApiModel::FixedSlot`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scheduled_capacity')
        self.scheduled_capacity = attributes[:'scheduled_capacity']
      end

      if attributes.key?(:'available_capacity')
        self.available_capacity = attributes[:'available_capacity']
      end

      if attributes.key?(:'encumbered_capacity')
        self.encumbered_capacity = attributes[:'encumbered_capacity']
      end

      if attributes.key?(:'reserved_capacity')
    ...
    def ==(o)
      ...
      self.class AmzSpApi::ServicesApiModel::V0::== o.class AmzSpApi::ServicesApiModel::V0::&&
          ...
          scheduled_capacity == o.scheduled_capacity &&
          available_capacity == o.available_capacity &&
          encumbered_capacity == o.encumbered_capacity &&
          reserved_capacity == o.reserved_capacity
    end
