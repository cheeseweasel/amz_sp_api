...
module AmzSpApi::ServicesApiModel
  ...
  class AmzSpApi::ServicesApiModel::V0::ServiceUploadDocument
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ServicesApiModel::ServiceUploadDocument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ServicesApiModel::ServiceUploadDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'content_md5')
        self.content_md5 = attributes[:'content_md5']
      end
    end
    ...
    def valid?
      ...
      content_type_validator = EnumAttributeValidator.new('Object', ['TIFF', 'JPG', 'PNG', 'JPEG', 'GIF', 'PDF'])
    ...
    def content_type=(content_type)
      validator = EnumAttributeValidator.new('Object', ['TIFF', 'JPG', 'PNG', 'JPEG', 'GIF', 'PDF'])
    ...
    def hash
      [content_type, content_length, content_md5].hash
    end
