...
module AmzSpApi::ServicesApiModel
  class AmzSpApi::ServicesApiModel::V0::CapacityType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ServicesApiModel::V0::#CapacityType" if constantValues.empty?
      value
    end
  end
end
