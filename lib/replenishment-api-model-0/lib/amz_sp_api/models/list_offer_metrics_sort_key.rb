...
module AmzSpApi::ReplenishmentApiModel
  class AmzSpApi::ReplenishmentApiModel::V0::ListOfferMetricsSortKey
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ReplenishmentApiModel::V0::#ListOfferMetricsSortKey" if constantValues.empty?
      value
    end
  end
end
