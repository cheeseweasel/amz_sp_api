...
module AmzSpApi::ReplenishmentApiModel
  class AmzSpApi::ReplenishmentApiModel::V0::EligibilityStatus
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ReplenishmentApiModel::V0::#EligibilityStatus" if constantValues.empty?
      value
    end
  end
end
