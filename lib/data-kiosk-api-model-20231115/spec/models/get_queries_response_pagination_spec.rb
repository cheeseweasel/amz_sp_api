...
# Unit tests for AmzSpApi::DataKioskApiModel::GetQueriesResponsePagination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetQueriesResponsePagination' do
  before do
    # run before each test
    @instance = AmzSpApi::DataKioskApiModel::GetQueriesResponsePagination.new
  end
  ...
  describe 'test an instance of GetQueriesResponsePagination' do
    it 'should create an instance of GetQueriesResponsePagination' do
      expect(@instance).to be_instance_of(AmzSpApi::DataKioskApiModel::GetQueriesResponsePagination)
    end
  end
