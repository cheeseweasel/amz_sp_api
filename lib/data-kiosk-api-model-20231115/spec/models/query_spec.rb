...
# Unit tests for AmzSpApi::DataKioskApiModel::Query
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Query' do
  before do
    # run before each test
    @instance = AmzSpApi::DataKioskApiModel::Query.new
  end
  ...
  describe 'test an instance of Query' do
    it 'should create an instance of Query' do
      expect(@instance).to be_instance_of(AmzSpApi::DataKioskApiModel::Query)
    end
  end
