...
module AmzSpApi::VendorOrdersApiModel
  ...
  class AmzSpApi::VendorOrdersApiModel::V0::Order
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::VendorOrdersApiModel::Order` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::VendorOrdersApiModel::Order`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'purchase_order_state')
        self.purchase_order_state = attributes[:'purchase_order_state']
      end
    ...
    def valid?
      ...
      purchase_order_state_validator = EnumAttributeValidator.new('Object', ['New', 'Acknowledged', 'Closed'])
    ...
    def purchase_order_state=(purchase_order_state)
      validator = EnumAttributeValidator.new('Object', ['New', 'Acknowledged', 'Closed'])
