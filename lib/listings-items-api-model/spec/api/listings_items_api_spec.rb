...
# Unit tests for AmzSpApi::ListingsItemsApiModel::ListingsItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::ListingsItemsApi.new
  end
  ...
  describe 'test an instance of ListingsItemsApi' do
    it 'should create an instance of ListingsItemsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::ListingsItemsApi)
    end
  end
