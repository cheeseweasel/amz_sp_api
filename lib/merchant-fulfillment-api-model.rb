...
require 'merchant-fulfillment-api-model/models/benefits'
...
require 'merchant-fulfillment-api-model/models/dangerous_goods_details'
...
require 'merchant-fulfillment-api-model/models/excluded_benefit'
require 'merchant-fulfillment-api-model/models/excluded_benefit_reason_codes'
require 'merchant-fulfillment-api-model/models/excluded_benefits'
...
require 'merchant-fulfillment-api-model/models/included_benefits'
...
require 'merchant-fulfillment-api-model/models/liquid_volume'
