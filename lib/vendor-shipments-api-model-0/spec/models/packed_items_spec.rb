...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::PackedItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackedItems' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::PackedItems.new
  end
  ...
  describe 'test an instance of PackedItems' do
    it 'should create an instance of PackedItems' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::PackedItems)
    end
  end
