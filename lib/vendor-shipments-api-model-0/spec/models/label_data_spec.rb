...
# Unit tests for AmzSpApi::VendorShipmentsApiModel::LabelData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelData' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipmentsApiModel::LabelData.new
  end
  ...
  describe 'test an instance of LabelData' do
    it 'should create an instance of LabelData' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipmentsApiModel::LabelData)
    end
  end
  describe 'test attribute "label_sequence_number"' do
    it 'should work' do
