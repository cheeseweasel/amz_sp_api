...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class AmzSpApi::VendorShipmentsApiModel::V0::Duration
    # Unit for duration.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::VendorShipmentsApiModel::Duration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::VendorShipmentsApiModel::Duration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'duration_value')
        self.duration_value = attributes[:'duration_value']
      end
    end
    ...
    def valid?
      ...
      duration_unit_validator = EnumAttributeValidator.new('Object', ['Days', 'Months'])
    ...
    def duration_unit=(duration_unit)
      validator = EnumAttributeValidator.new('Object', ['Days', 'Months'])
