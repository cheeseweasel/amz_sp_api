...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class AmzSpApi::VendorShipmentsApiModel::V0::CarrierDetails
    ...
    attr_accessor :shipment_reference_number
    ...
    def self.openapi_types
      {
        ...
        :'phone' => :'Object',
        :'email' => :'Object',
        :'shipment_reference_number' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::VendorShipmentsApiModel::CarrierDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::VendorShipmentsApiModel::CarrierDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipment_reference_number')
        self.shipment_reference_number = attributes[:'shipment_reference_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::VendorShipmentsApiModel::V0::== o.class AmzSpApi::VendorShipmentsApiModel::V0::&&
          ...
          phone == o.phone &&
          email == o.email &&
          shipment_reference_number == o.shipment_reference_number
    end
    ...
    def hash
      [name, code, phone, email, shipment_reference_number].hash
    end
