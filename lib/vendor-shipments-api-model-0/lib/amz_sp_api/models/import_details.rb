...
module AmzSpApi::VendorShipmentsApiModel
  ...
  class AmzSpApi::VendorShipmentsApiModel::V0::ImportDetails
    ...
    attr_accessor :handling_instructions
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'handling_instructions')
        self.handling_instructions = attributes[:'handling_instructions']
      end
    end
    ...
    def valid?
      ...
      handling_instructions_validator = EnumAttributeValidator.new('Object', ['Oversized', 'Fragile', 'Food', 'HandleWithCare'])
      return false unless handling_instructions_validator.valid?(@handling_instructions)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] handling_instructions Object to be assigned
    def handling_instructions=(handling_instructions)
      validator = EnumAttributeValidator.new('Object', ['Oversized', 'Fragile', 'Food', 'HandleWithCare'])
      unless validator.valid?(handling_instructions)
        fail ArgumentError, "invalid value for \"handling_instructions\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::VendorShipmentsApiModel::V0::== o.class AmzSpApi::VendorShipmentsApiModel::V0::&&
          ...
          handling_instructions == o.handling_instructions
    end
    ...
    def hash
      [method_of_payment, seal_number, route, import_containers, billable_weight, estimated_ship_by_date, handling_instructions].hash
    end
