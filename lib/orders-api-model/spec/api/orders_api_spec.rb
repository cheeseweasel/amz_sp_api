...
# Unit tests for AmzSpApi::OrdersApiModel::OrdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersApi' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersApiModel::OrdersApi.new
  end
  ...
  describe 'test an instance of OrdersApi' do
    it 'should create an instance of OrdersApi' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersApiModel::OrdersApi)
    end
  end
