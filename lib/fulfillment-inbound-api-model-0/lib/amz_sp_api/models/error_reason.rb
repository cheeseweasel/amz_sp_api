...
module AmzSpApi::FulfillmentInboundApiModel
  class AmzSpApi::FulfillmentInboundApiModel::V0::ErrorReason
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentInboundApiModel::V0::#ErrorReason" if constantValues.empty?
      value
    end
  end
end
