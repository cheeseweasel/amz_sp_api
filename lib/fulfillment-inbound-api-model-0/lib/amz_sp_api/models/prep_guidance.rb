...
module AmzSpApi::FulfillmentInboundApiModel
  class AmzSpApi::FulfillmentInboundApiModel::V0::PrepGuidance
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentInboundApiModel::V0::#PrepGuidance" if constantValues.empty?
      value
    end
  end
end
