...
module AmzSpApi::CatalogItemsApiModel
  ...
  class AmzSpApi::CatalogItemsApiModel::V20220401::Item
    attr_accessor :asin
    ...
    def hash
      [asin, attributes, classifications, dimensions, identifiers, images, product_types, relationships, sales_ranks, summaries, vendor_details].hash
    end
