...
module AmzSpApi::CatalogItemsApiModel
  ...
  class AmzSpApi::CatalogItemsApiModel::V20220401::ItemBrowseClassificationsByMarketplace
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::CatalogItemsApiModel::ItemBrowseClassificationsByMarketplace` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::CatalogItemsApiModel::ItemBrowseClassificationsByMarketplace`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class AmzSpApi::CatalogItemsApiModel::V20220401::== o.class AmzSpApi::CatalogItemsApiModel::V20220401::&&
    ...
    def hash
      [marketplace_id, classifications].hash
    end
