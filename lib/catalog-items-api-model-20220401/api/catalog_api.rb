...
module AmzSpApi::CatalogItemsApiModel::V20220401
  class CatalogApi
    ...
    def initialize(api_client = AmzSpApi::CatalogItemsApiModel::V20220401::ApiClient.default)
    ...
    def get_catalog_item_with_http_info(asin, marketplace_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'included_data'] && !opts[:'included_data'].all? { |item| ['attributes', 'classifications', 'dimensions', 'identifiers', 'images', 'productTypes', 'relationships', 'salesRanks', 'summaries', 'vendorDetails'].include?(item) }
        fail ArgumentError, 'invalid value for "included_data", must include one of attributes, classifications, dimensions, identifiers, images, productTypes, relationships, salesRanks, summaries, vendorDetails'
      end
      # resource path
    ...
    # @option opts [Integer] :page_size The number of results to include on each page. (default to 10)
