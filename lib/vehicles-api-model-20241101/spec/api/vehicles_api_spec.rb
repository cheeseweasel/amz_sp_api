...
# Unit tests for AmzSpApi::VehiclesApiModel::VehiclesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VehiclesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VehiclesApiModel::VehiclesApi.new
  end
  ...
  describe 'test an instance of VehiclesApi' do
    it 'should create an instance of VehiclesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VehiclesApiModel::VehiclesApi)
    end
  end
