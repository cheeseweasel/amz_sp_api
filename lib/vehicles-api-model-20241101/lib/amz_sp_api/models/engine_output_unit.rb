...
module AmzSpApi::VehiclesApiModel
  class AmzSpApi::VehiclesApiModel::V20241101::EngineOutputUnit
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::VehiclesApiModel::V20241101::#EngineOutputUnit" if constantValues.empty?
      value
    end
  end
end
