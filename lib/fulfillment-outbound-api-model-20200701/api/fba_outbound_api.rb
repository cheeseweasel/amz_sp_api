...
module AmzSpApi::FulfillmentOutboundApiModel::V20200701
  class FbaOutboundApi
    ...
    def initialize(api_client = AmzSpApi::FulfillmentOutboundApiModel::V20200701::ApiClient.default)
    ...
    def delivery_offers(body, opts = {})
      data, _status_code, _headers = delivery_offers_with_http_info(body, opts)
      data
    end
    ...
    # @param body GetDeliveryOffersRequest parameter
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDeliveryOffersResponse, Integer, Hash)>] GetDeliveryOffersResponse data, response status code and response headers
    def delivery_offers_with_http_info(body, opts = {})
      ...
      return_type = opts[:return_type] || 'GetDeliveryOffersResponse' 
    ...
    def list_return_reason_codes(seller_sku, opts = {})
      data, _status_code, _headers = list_return_reason_codes_with_http_info(seller_sku, opts)
      data
    end
