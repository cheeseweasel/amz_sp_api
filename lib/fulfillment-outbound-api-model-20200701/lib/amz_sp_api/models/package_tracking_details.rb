...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::PackageTrackingDetails
    ...
    def hash
      [package_number, tracking_number, customer_tracking_link, carrier_code, carrier_phone_number, carrier_url, ship_date, estimated_arrival_date, ship_to_address, current_status, current_status_description, delivery_window, signed_for_by, additional_location_info, tracking_events].hash
    end
