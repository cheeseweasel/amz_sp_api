...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::FulfillmentShipment
    ...
    class AmzSpApi::FulfillmentOutboundApiModel::V20200701::EnumAttributeValidator
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fulfillment_shipment_status')
        self.fulfillment_shipment_status = attributes[:'fulfillment_shipment_status']
      end
      ...
      if attributes.key?(:'shipping_notes')
        if (value = attributes[:'shipping_notes']).is_a?(Array)
          self.shipping_notes = value
        end
      end

      if attributes.key?(:'fulfillment_shipment_item')
        self.fulfillment_shipment_item = attributes[:'fulfillment_shipment_item']
      end

      if attributes.key?(:'fulfillment_shipment_package')
    ...
    def valid?
      ...
      fulfillment_shipment_status_validator = EnumAttributeValidator.new('Object', ['PENDING', 'SHIPPED', 'CANCELLED_BY_FULFILLER', 'CANCELLED_BY_SELLER'])
    ...
    def fulfillment_shipment_status=(fulfillment_shipment_status)
      validator = EnumAttributeValidator.new('Object', ['PENDING', 'SHIPPED', 'CANCELLED_BY_FULFILLER', 'CANCELLED_BY_SELLER'])
