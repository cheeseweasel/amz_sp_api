...
module AmzSpApi::FulfillmentOutboundApiModel
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::AdditionalLocationInfo
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentOutboundApiModel::V20200701::#AdditionalLocationInfo" if constantValues.empty?
      value
    end
  end
end
