...
module AmzSpApi::FulfillmentOutboundApiModel
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::EventCode
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentOutboundApiModel::V20200701::#EventCode" if constantValues.empty?
      value
    end
  end
end
