...
module AmzSpApi::FulfillmentOutboundApiModel
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::ReturnItemDisposition
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::FulfillmentOutboundApiModel::V20200701::#ReturnItemDisposition" if constantValues.empty?
      value
    end
  end
end
