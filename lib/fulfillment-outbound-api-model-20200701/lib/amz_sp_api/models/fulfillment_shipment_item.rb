...
module AmzSpApi::FulfillmentOutboundApiModel
  ...
  class AmzSpApi::FulfillmentOutboundApiModel::V20200701::FulfillmentShipmentItem
    ...
    attr_accessor :manufacturer_lot_codes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'manufacturer_lot_codes')
        self.manufacturer_lot_codes = attributes[:'manufacturer_lot_codes']
      end
    end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::FulfillmentOutboundApiModel::V20200701::== o.class AmzSpApi::FulfillmentOutboundApiModel::V20200701::&&
          ...
          manufacturer_lot_codes == o.manufacturer_lot_codes
    end
    ...
    def hash
      [seller_sku, seller_fulfillment_order_item_id, quantity, package_number, serial_number, manufacturer_lot_codes].hash
    end
