...
module AmzSpApi::FbaInventoryApiModel
  ...
  class AmzSpApi::FbaInventoryApiModel::V0::InventorySummary
    ...
    def hash
      [asin, fn_sku, seller_sku, condition, inventory_details, last_updated_time, product_name, total_quantity, stores].hash
    end
