...
module AmzSpApi::ProductPricingApiModel
  class AmzSpApi::ProductPricingApiModel::V0::ConditionType
    NEW = 'New'.freeze
    USED = 'Used'.freeze
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ProductPricingApiModel::V0::#ConditionType" if constantValues.empty?
      value
    end
  end
end
