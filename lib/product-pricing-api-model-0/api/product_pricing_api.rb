...
module AmzSpApi::ProductPricingApiModel::V0
  class ProductPricingApi
    ...
    def initialize(api_client = AmzSpApi::ProductPricingApiModel::V0::ApiClient.default)
    ...
    # @param body The request associated with the &#x60;getItemOffersBatch&#x60; API call.
    # @param [Hash] opts the optional parameters
    ...
    # @param body The request associated with the &#x60;getListingOffersBatch&#x60; API call.
    # @param [Hash] opts the optional parameters
