...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::Pagination
...
describe 'Pagination' do
  ...
  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::Pagination)
    end
  end
