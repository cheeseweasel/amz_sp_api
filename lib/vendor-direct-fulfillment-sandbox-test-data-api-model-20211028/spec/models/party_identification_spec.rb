...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::PartyIdentification
...
describe 'PartyIdentification' do
  ...
  describe 'test an instance of PartyIdentification' do
    it 'should create an instance of PartyIdentification' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::PartyIdentification)
    end
  end
