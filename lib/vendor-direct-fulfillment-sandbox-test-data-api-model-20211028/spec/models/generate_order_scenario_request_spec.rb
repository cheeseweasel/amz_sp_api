...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::GenerateOrderScenarioRequest
...
describe 'GenerateOrderScenarioRequest' do
  ...
  describe 'test an instance of GenerateOrderScenarioRequest' do
    it 'should create an instance of GenerateOrderScenarioRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel::GenerateOrderScenarioRequest)
    end
  end
