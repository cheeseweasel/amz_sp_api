...
module AmzSpApi::AmazonWarehousingAndDistributionModel
  ...
  class InboundShipment
    ...
    def hash
      [carrier_code, created_at, destination_address, external_reference_id, order_id, origin_address, received_quantity, ship_by, shipment_container_quantities, shipment_id, shipment_sku_quantities, shipment_status, tracking_id, updated_at, warehouse_reference_id].hash
    end
