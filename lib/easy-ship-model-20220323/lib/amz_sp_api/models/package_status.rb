...
module AmzSpApi::EasyShipModel
  class AmzSpApi::EasyShipModel::V20220323::PackageStatus
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::EasyShipModel::V20220323::#PackageStatus" if constantValues.empty?
      value
    end
  end
end
