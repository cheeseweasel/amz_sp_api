...
# Unit tests for AmzSpApi::ListingsItemsApiModel::ItemRelationshipsByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemRelationshipsByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::ItemRelationshipsByMarketplace.new
  end
  ...
  describe 'test an instance of ItemRelationshipsByMarketplace' do
    it 'should create an instance of ItemRelationshipsByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::ItemRelationshipsByMarketplace)
    end
  end
