...
# Unit tests for AmzSpApi::ListingsItemsApiModel::ItemProductTypeByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemProductTypeByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::ItemProductTypeByMarketplace.new
  end
  ...
  describe 'test an instance of ItemProductTypeByMarketplace' do
    it 'should create an instance of ItemProductTypeByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::ItemProductTypeByMarketplace)
    end
  end
