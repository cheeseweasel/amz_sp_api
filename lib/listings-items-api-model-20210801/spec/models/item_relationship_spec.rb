...
# Unit tests for AmzSpApi::ListingsItemsApiModel::ItemRelationship
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemRelationship' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItemsApiModel::ItemRelationship.new
  end
  ...
  describe 'test an instance of ItemRelationship' do
    it 'should create an instance of ItemRelationship' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItemsApiModel::ItemRelationship)
    end
  end
