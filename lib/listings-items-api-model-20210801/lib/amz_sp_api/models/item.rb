...
module AmzSpApi::ListingsItemsApiModel
  # A listings item.
  class AmzSpApi::ListingsItemsApiModel::V20210801::Item
    ...
    def hash
      [sku, summaries, attributes, issues, offers, fulfillment_availability, procurement, relationships, product_types].hash
    end
