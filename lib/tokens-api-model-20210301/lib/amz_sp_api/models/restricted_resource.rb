...
module AmzSpApi::TokensApiModel
  ...
  class AmzSpApi::TokensApiModel::V20210301::RestrictedResource
    ...
    class AmzSpApi::TokensApiModel::V20210301::EnumAttributeValidator
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::TokensApiModel::RestrictedResource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::TokensApiModel::RestrictedResource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_elements')
        if (value = attributes[:'data_elements']).is_a?(Array)
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('Object', ['GET', 'PUT', 'POST', 'DELETE'])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('Object', ['GET', 'PUT', 'POST', 'DELETE'])
    ...
    def ==(o)
      ...
      self.class AmzSpApi::TokensApiModel::V20210301::== o.class AmzSpApi::TokensApiModel::V20210301::&&
          method == o.method &&
          path == o.path &&
