...
module AmzSpApi::AplusContentApiModel
  class AmzSpApi::AplusContentApiModel::V20201101::ContentModuleType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::AplusContentApiModel::V20201101::#ContentModuleType" if constantValues.empty?
      value
    end
  end
end
