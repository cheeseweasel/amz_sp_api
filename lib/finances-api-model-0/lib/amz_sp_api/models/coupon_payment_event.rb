...
module AmzSpApi::FinancesApiModel
  ...
  class AmzSpApi::FinancesApiModel::V0::CouponPaymentEvent
    ...
    def self.openapi_types
      {
        :'posted_date' => :'Object',
        :'coupon_id' => :'Object',
        :'seller_coupon_description' => :'Object',
        :'clip_or_redemption_count' => :'Object',
        :'payment_event_id' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::FinancesApiModel::CouponPaymentEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::FinancesApiModel::CouponPaymentEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'seller_coupon_description')
        self.seller_coupon_description = attributes[:'seller_coupon_description']
      end

      if attributes.key?(:'clip_or_redemption_count')
        self.clip_or_redemption_count = attributes[:'clip_or_redemption_count']
      end
