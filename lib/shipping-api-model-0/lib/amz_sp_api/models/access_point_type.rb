...
module AmzSpApi::ShippingApiModel
  class AmzSpApi::ShippingApiModel::V0::AccessPointType
    HELIX = 'HELIX'.freeze
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ShippingApiModel::V0::#AccessPointType" if constantValues.empty?
      value
    end
  end
end
