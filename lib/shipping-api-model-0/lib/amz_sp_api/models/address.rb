...
module AmzSpApi::ShippingApiModel
  # The address.
  class AmzSpApi::ShippingApiModel::V0::Address
    ...
    def hash
      [name, address_line1, address_line2, address_line3, company_name, state_or_region, city, country_code, postal_code, email, phone_number, geocode].hash
    end
