...
module AmzSpApi::ShippingApiModel
  class AmzSpApi::ShippingApiModel::V0::ShipmentType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ShippingApiModel::V0::#ShipmentType" if constantValues.empty?
      value
    end
  end
end
