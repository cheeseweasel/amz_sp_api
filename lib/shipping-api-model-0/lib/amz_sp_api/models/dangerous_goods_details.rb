...
module AmzSpApi::ShippingApiModel
  ...
  class AmzSpApi::ShippingApiModel::V0::DangerousGoodsDetails
    # The specific UNID of the item being shipped.
    attr_accessor :united_nations_regulatory_id

    # The specific regulatory class AmzSpApi::ShippingApiModel::V0:: of the item being shipped.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ShippingApiModel::DangerousGoodsDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ShippingApiModel::DangerousGoodsDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transportation_regulatory_class')
        self.transportation_regulatory_class AmzSpApi::ShippingApiModel::V0::= attributes[:'transportation_regulatory_class']
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::ShippingApiModel::V0::== o.class AmzSpApi::ShippingApiModel::V0::&&
          ...
          transportation_regulatory_class AmzSpApi::ShippingApiModel::V0::== o.transportation_regulatory_class AmzSpApi::ShippingApiModel::V0::&&
