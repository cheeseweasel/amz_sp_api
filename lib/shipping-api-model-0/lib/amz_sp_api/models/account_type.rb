...
module AmzSpApi::ShippingApiModel
  class AmzSpApi::ShippingApiModel::V0::AccountType
    ...
    def build_from_hash(value)
      ...
      raise "Invalid ENUM value #{value} for class AmzSpApi::ShippingApiModel::V0::#AccountType" if constantValues.empty?
      value
    end
  end
end
