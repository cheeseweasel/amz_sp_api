...
module AmzSpApi::ShippingApiModel
  ...
  class AmzSpApi::ShippingApiModel::V0::IneligibleRate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ShippingApiModel::IneligibleRate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ShippingApiModel::IneligibleRate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @ineligibility_reasons.nil?
        invalid_properties.push('invalid value for "ineligibility_reasons", ineligibility_reasons cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ineligibility_reasons.nil?
      true
    end
    ...
    def hash
      [service_id, service_name, carrier_name, carrier_id, ineligibility_reasons].hash
    end
