...
module AmzSpApi::ShippingApiModel
  ...
  class AmzSpApi::ShippingApiModel::V0::OneClickShipmentRequest
    ...
    attr_accessor :goods_owner

    attr_accessor :packages

    attr_accessor :value_added_services_details

    attr_accessor :tax_details

    attr_accessor :channel_details

    attr_accessor :label_specifications

    attr_accessor :service_selection
    ...
    def self.openapi_types
      {
        ...
        :'goods_owner' => :'Object',
        :'packages' => :'Object',
        :'value_added_services_details' => :'Object',
        :'tax_details' => :'Object',
        :'channel_details' => :'Object',
        :'label_specifications' => :'Object',
        :'service_selection' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::ShippingApiModel::OneClickShipmentRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::ShippingApiModel::OneClickShipmentRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'goods_owner')
        self.goods_owner = attributes[:'goods_owner']
      end
      ...
      if attributes.key?(:'value_added_services_details')
        self.value_added_services_details = attributes[:'value_added_services_details']
      end
      ...
      if attributes.key?(:'label_specifications')
        self.label_specifications = attributes[:'label_specifications']
      end

      if attributes.key?(:'service_selection')
        self.service_selection = attributes[:'service_selection']
      end
    ...
    def list_invalid_properties
      ...
      if @label_specifications.nil?
        invalid_properties.push('invalid value for "label_specifications", label_specifications cannot be nil.')
      end

      if @service_selection.nil?
        invalid_properties.push('invalid value for "service_selection", service_selection cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @label_specifications.nil?
      return false if @service_selection.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::ShippingApiModel::V0::== o.class AmzSpApi::ShippingApiModel::V0::&&
          ...
          goods_owner == o.goods_owner &&
          packages == o.packages &&
          value_added_services_details == o.value_added_services_details &&
          tax_details == o.tax_details &&
          channel_details == o.channel_details &&
          label_specifications == o.label_specifications &&
          service_selection == o.service_selection &&
    ...
    def hash
      [ship_to, ship_from, return_to, ship_date, goods_owner, packages, value_added_services_details, tax_details, channel_details, label_specifications, service_selection, shipper_instruction, destination_access_point_details].hash
    end
