...
# Unit tests for AmzSpApi::ShippingApiModel::TimeWindow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeWindow' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::TimeWindow.new
  end
  ...
  describe 'test an instance of TimeWindow' do
    it 'should create an instance of TimeWindow' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::TimeWindow)
    end
  end
