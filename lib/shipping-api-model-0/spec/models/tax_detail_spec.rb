...
# Unit tests for AmzSpApi::ShippingApiModel::TaxDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingApiModel::TaxDetail.new
  end
  ...
  describe 'test an instance of TaxDetail' do
    it 'should create an instance of TaxDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingApiModel::TaxDetail)
    end
  end
