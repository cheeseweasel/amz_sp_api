...
module AmzSpApi::CatalogItemsApiModel
  ...
  class AmzSpApi::CatalogItemsApiModel::V20201201::Item
    attr_accessor :asin
    ...
    def hash
      [asin, attributes, identifiers, images, product_types, sales_ranks, summaries, variations, vendor_details].hash
    end
