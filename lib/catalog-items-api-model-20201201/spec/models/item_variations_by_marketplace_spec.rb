...
# Unit tests for AmzSpApi::CatalogItemsApiModel::ItemVariationsByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemVariationsByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItemsApiModel::ItemVariationsByMarketplace.new
  end
  ...
  describe 'test an instance of ItemVariationsByMarketplace' do
    it 'should create an instance of ItemVariationsByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItemsApiModel::ItemVariationsByMarketplace)
    end
  end
