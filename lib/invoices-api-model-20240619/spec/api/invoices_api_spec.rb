...
# Unit tests for AmzSpApi::InvoicesApiModel::InvoicesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::InvoicesApiModel::InvoicesApi.new
  end
  ...
  describe 'test an instance of InvoicesApi' do
    it 'should create an instance of InvoicesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::InvoicesApiModel::InvoicesApi)
    end
  end
