...
# Unit tests for AmzSpApi::VendorInvoicesApiModel::TotalWeight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TotalWeight' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorInvoicesApiModel::TotalWeight.new
  end
  ...
  describe 'test an instance of TotalWeight' do
    it 'should create an instance of TotalWeight' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorInvoicesApiModel::TotalWeight)
    end
  end
