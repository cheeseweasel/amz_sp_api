...
module AmzSpApi::VendorInvoicesApiModel
  ...
  class AmzSpApi::VendorInvoicesApiModel::V0::InvoiceItem
    ...
    attr_accessor :net_cost_unit_of_measure
    ...
    def self.openapi_types
      {
        ...
        :'net_cost' => :'Object',
        :'net_cost_unit_of_measure' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::VendorInvoicesApiModel::InvoiceItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::VendorInvoicesApiModel::InvoiceItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'net_cost_unit_of_measure')
        self.net_cost_unit_of_measure = attributes[:'net_cost_unit_of_measure']
      end
    ...
    def ==(o)
      ...
      self.class AmzSpApi::VendorInvoicesApiModel::V0::== o.class AmzSpApi::VendorInvoicesApiModel::V0::&&
          ...
          net_cost == o.net_cost &&
          net_cost_unit_of_measure == o.net_cost_unit_of_measure &&
    ...
    def hash
      [item_sequence_number, amazon_product_identifier, vendor_product_identifier, invoiced_quantity, net_cost, net_cost_unit_of_measure, purchase_order_number, hsn_code, credit_note_details, tax_details, charge_details, allowance_details].hash
    end
